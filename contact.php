      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          <div class="col-md-12 mb-4">
            <h2 class="text-center coninfo">Contact Information</h2>
          </div>
          <div class="w-100"></div>
          ...
          <div class="col-md-4">
            ...
            <p class="coninfo text-center"></p>
            <p class="text-dark text-center">SB-43 second floor, Highland Corporate center, Highstreet Mall, Kapurbawdi junction, Thane (w) 400607</p>
          </div>
          <div class="col-md-4">
            <center>
              <img src="images/icons/mail.png" alt="mail">
            </center>
            <p class="text-dark text-center"><a class="textclr" href="mailto:info@yashconstructions.co.in">info@yashconstructions.co.in</a></p>
          </div>
          <div class="col-md-4">
            <center>
              <img src="images/icons/mobile.png" alt="mobile">
            </center>
            <p class="text-dark text-center"><a class="textclr" href="tel://+91 93247 57884">+91 93247 57884</a></p>
          </div>
        </div>
